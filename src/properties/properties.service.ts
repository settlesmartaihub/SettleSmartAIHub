...
import { Property, PropertyStatus, PropertyVerificationStatus, PropertyType, PropertyAmenities } from '../modules/properties/entities/property.entity';
...
export class PropertiesService {
    ...
    async createProperty(agentId: string, createPropertyDto: CreatePropertyDto): Promise<Property> {
        ...
        const property = this.propertyRepository.create({
            ...
            location: {
                ...
                coordinates: await this.getCoordinates(createPropertyDto.location.address)
            },
    ...
    async searchProperties(searchDto: PropertySearchDto): Promise<PaginatedResponse<Property>> {
        ...
        `, {
                ...
                // Search by area name
                query.andWhere("property.location->>'area' ILIKE :area", { area: `%${location.area}%` });
            }
        }
        ...
        query.orderBy(`property.${sortField}`, sortOrder);
